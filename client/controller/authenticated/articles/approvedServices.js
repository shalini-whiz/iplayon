Template.myApprovedServices.onCreated(function(){

});

Template.myApprovedServices.helpers({
	"approvedPackageList":function()
	{
		try{
...
Template.myApprovedServices.events({

	"click #ackService1":function(e)
	{
		try{
