...
Template.tournSchedulerEditPast.onCreated(function() {
...
var selectedOrders = []
var selectedData = []
Template.tournSchedulerEditPast.onRendered(function() {
...
Template.tournSchedulerEditPast.onDestroyed(function() {

})

Template.tournSchedulerEditPast.helpers({
    notAdmin: function() {
        try {
...
Template.tournSchedulerEditPast.events({
    ...
    "click #generateScheduleForTour": function(e) {
        try {
            if (Session.get("getMaxEventPartsCountroSess") == undefined || selectedData.length == 0) {
                ...
                var check = checkBasictimeValidEditPast()
                if (check) {
...
export const checkBasicDurationValidEditPast = function(){
