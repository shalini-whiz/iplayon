...
//dshfskdgf
evenSportsDates = new Meteor.Collection('evenSportsDates');

evenSportsDatesSchema = new SimpleSchema({
	"eventOrganizer":{
		type:String,
	},
	"toDate":{
	...
	"eventOrTournamentIds":{
		type:[String]
	}
})

evenSportsDates.attachSchema(evenSportsDatesSchema);
