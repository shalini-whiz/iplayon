userDetailsTT.after.insert(function (userId, doc) {
	try{
		if(doc)
		{
			data = doc;
        	var entryExists = userDetailsTT.findOne({"_id":doc._id});
            var smsData = {};
            var smsTemplate = "";
        	if(entryExists)
        	{   	
...
userDetailsTT.after.update(function(userId, doc, fieldNames, modifier, options){
	try{
		if(doc)
		{
			data = doc;
